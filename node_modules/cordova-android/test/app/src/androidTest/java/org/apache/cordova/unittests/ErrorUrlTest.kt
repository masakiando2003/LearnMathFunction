...
class ErrorUrlTest {
    ...
    fun launchApplicationWithIntent() {
        ...
        mActivity = mActivityRule.launchActivity(intent) as TestActivity
    }
    ...
    companion object {
        private val START_URL = "file:///android_asset/www/htmlnotfound/index.html"
        private val ERROR_URL = "file:///android_asset/www/htmlnotfound/error.html"
        private val INVALID_URL = "file:///android_asset/www/invalid.html"
