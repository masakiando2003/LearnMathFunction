...
object PermissionHelper {
    private val LOG_TAG = "CordovaPermissionHelper"
    ...
    fun requestPermission(plugin: CordovaPlugin, requestCode: Int, permission: String) {
        PermissionHelper.requestPermissions(plugin, requestCode, arrayOf(permission))
    }
     ...
     */
    fun hasPermission(plugin: CordovaPlugin, permission: String): Boolean {
        return plugin.cordova.hasPermission(permission)
    }

    private fun deliverPermissionResult(plugin: CordovaPlugin, requestCode: Int, permissions: Array<String>) {
        // Generate the request results
        val requestResults = IntArray(permissions.size)
